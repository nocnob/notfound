...
----
debian.home {
    file /etc/coredns/debian.home.zone
    log
}
...
./etc/coredns/db.debian.home
[source,dns-zone]
----
$ORIGIN debian.home.
$TTL 8h
@       3600 IN SOA ns1.debian.home. hostmaster.debian.home. (
                                2024062201 ; serial
                                2h         ; refresh (2 hours)
                                1h         ; retry (1 hour)
                                14d        ; expire (2 weeks)
        ...
        IN NS ns1.debian.home.
        IN NS ns2.debian.home.
        IN MX 10 mail.debian.home.
...
----
host debian.home
# debian.home has address 192.168.0.14
# debian.home mail is handled by 10 mail.debian.home.

host www.debian.home
# www.debian.home has address 127.0.0.1
# www.debian.home has IPv6 address ::1
----
