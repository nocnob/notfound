...
[source,bash]
----
sed -i 's/ca1\.demo\.com/ca2\.demo\.com/g' openssl.cnf
touch ca2.demo.com/index.txt
echo "01" > ca2.demo.com/serial
----
+
修改 `openssl.cnf`，在 `[CA_default]` 段：
+
[source,diff]
----
...
[source,bash]
----
openssl genrsa -out ca2.demo.com/private/ca2.demo.pem 2048
openssl req -config openssl.cnf \
  -new -key ca2.demo.com/private/ca2.demo.com.pem \
  -out ca2.demo.com.csr
----
